 ...
 *
 */
$title = "<center>Fingerprint Detected connection</center>"; // website's title
$servers = array(
        'Karet Mas depan' => array(
        'ip' => '192.168.103.107',
        'port' => 4370,
        'info' => '192.168.103.107',
        'purpose' => 'ip addreess'
    ),
     	'EKA JAYA' => array(
        'ip' => '192.168.1.202',
       ...
       'Gudang Peternakan' => array(
        'ip' => '192.168.102.79',
        'port' => 4370,
        'info' => '192.168.102.79',
        'purpose' => 'ip addreess'
    ),
       'Gudang Kencana' => array(
        'ip' => '192.168.104.82',
        'port' => 4370,
        'info' => '192.168.104.82',
        'purpose' => 'ip addreess'
                ...
                <tbody>
                    ...
                    <?php foreach ($servers as $name => $server): ?>
                        ...
                        <tr id="<?php echo md5($name); ?>">
                            ...
                            <td class="name"><i class="icon-spinner icon-spin icon-large"></i></td>
                            <td ><?php echo $name; ?></td>
